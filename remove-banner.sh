...
tput cup 6 30
echo -e "\x1b[42m LINUX by PROFESSOR\x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel LINUX for more hacking videos (y/n)? \e[m "
read answer
...
tput cup 17 23
    echo -e "\x1b[41m Please subsrcibe channel \x1b[m"
fi
tput cup 20 0
figlet -f slant "LINUX by PROFESSOR" |lolcat
echo " "
echo " "
