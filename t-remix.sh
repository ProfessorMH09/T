...
#        Author: PROFESSOR          #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO PROFESSOR TOOLS  \e[m "
echo
...
echo "
        ...
        WELCOME TO PROFESSOR TOOLS_-^^TECH KNOW LINUX^^-_
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY PROFESSOR\e[m "
